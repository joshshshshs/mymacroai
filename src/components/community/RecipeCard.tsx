        ...
        >
            ...
            <View style={styles.content}>
                ...
                <View style={styles.macroRow}>
                    ...
                    <Text style={[styles.macroText, { color: colors.textSecondary }]}>P: {recipe.protein}g</Text>
                    <View style={[styles.macroDot, { backgroundColor: colors.macros.carbs }]} />
                    <Text style={[styles.macroText, { color: colors.textSecondary }]}>C: {recipe.carbs}g</Text>
                    <View style={[styles.macroDot, { backgroundColor: colors.macros.fats }]} />
                    <Text style={[styles.macroText, { color: colors.textSecondary }]}>F: {recipe.fats}g</Text>
                </View>
                ...
                {recipe.author && (
                    ...
                    >
                        {recipe.author.avatar_url ? (
                            ...
                            <View style={[styles.authorAvatar, styles.avatarPlaceholder, { backgroundColor: colors.textMuted }]}>

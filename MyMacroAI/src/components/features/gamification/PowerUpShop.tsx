 ...
 *
 * A horizontal carousel at the bottom of the streak page where users
 * can spend earned "Consistency Points" (MacroCoins) on app utilities.
 *
 * Items:
 * - Streak Freeze: Protect streak for 1 day (500 coins)
 * - Theme Unlock: Dark Mode themes (1000 coins)
 * - Ghost Mode: Hide from Leaderboard 24h (200 coins)
 * - Double XP: 2x coins for 24h (750 coins)
 */
...
const POWER_UPS: PowerUp[] = [
    ...
    },
    {
        id: 'theme-aurora',
        name: 'Aurora Theme',
        description: 'Unlock: Northern Lights',
        cost: 1500,
        icon: 'sparkles',
        ...
        <View style={[styles.container, { backgroundColor: cardBg }]}>
            ...
            {ownedFreezes > 0 && (
                <View style={styles.ownedIndicator}>
                    ...
                    <Text style={[styles.ownedText, { color: COLORS.gamification.iceBlue }]}>

 ...
 * Psychology: Showing the *next* reward keeps users engaged.
 *
 * Milestone Tiers:
 * - 3 days: Starter (Bronze)
 * - 7 days: Warrior (Silver)
 * - 14 days: Spartan (Gold)
 * - 30 days: Titan (Platinum)
 * - 60 days: Champion (Diamond)
 * - 100 days: Legend (Cosmic)
 */
...
const MilestoneNode: React.FC<{
    ...
    isLocked: boolean;
    progress: number;
}> = ({ milestone, isAchieved, isCurrent, isLocked, progress }) => {
        ...
        return (
            <Animated.View style={[styles.nodeWrapper, nodeStyle]}>
                ...
                <View style={styles.nodeCurrent}>
                    <LinearGradient
                        colors={[`${config.badgeColor}20`, `${config.badgeColor}10`]}
                        style={styles.nodeCurrentInner}
                    >
                        <Text style={styles.nodeIcon}>{milestone.icon}</Text>
                    </LinearGradient>
                    {/* Circular progress indicator */}
                    <View style={[styles.progressArc, { borderColor: config.badgeColor }]}>
                        <View
                            style={[
                                styles.progressFillArc,
                                {
            ...
            <View style={styles.header}>
                <View>
                    ...
                    <Text style={[styles.subtitle, { color: textColor }]}>
                        {nextMilestone ? `${nextMilestone.title} in ${daysUntilNext} days` : 'All milestones achieved!'}
                    </Text>
                </View>
                            ...
                            <View style={[styles.milestoneContent, isLocked && styles.contentLocked]}>
                                <View style={styles.titleRow}>
                                    <Text
                                        style={[
                                            ...
                                            { color: textColor },
                                            isAchieved && styles.titleAchieved,
                                ...
                                {isAchieved && milestone.achievedDate && (
                                    <View style={styles.achievedRow}>
                                        ...
                                        <Text style={[styles.achievedText, { color: COLORS.gamification.springGreen }]}>
...
const styles = StyleSheet.create({
    ...
    progressArc: {
        ...
        borderTopColor: COLORS.gamification.vitaminOrange,
    },
    progressFillArc: {
        position: 'absolute',
        width: 4,

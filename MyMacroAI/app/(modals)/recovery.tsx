          ...
          {recommendation && (
            <View style={[styles.recommendationCard, { backgroundColor: `${getScoreColor(recoveryScore)}15` }]}>
              <View style={styles.recommendationHeader}>
                <Ionicons
                  name={recommendation.intensity === 'high' ? 'flash' : recommendation.intensity === 'moderate' ? 'walk' : 'bed'}
                  size={20}
              ...
              <View style={styles.recommendationMeta}>
                <Text style={styles.recommendationIntensity}>
                  Recommended: {recommendation.intensity.charAt(0).toUpperCase() + recommendation.intensity.slice(1)} Intensity
                </Text>
              </View>
            </View>
          )}
